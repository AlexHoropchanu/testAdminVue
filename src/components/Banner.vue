<template>
  <div class="wrapper">
    ...
    <label><span>Url: </span><input type="text" :value="card.url" /></label><br/>
    <label><span> Текст:</span> <input type="text" :value="card.text" /></label><br/>
    <button @click="deleteBanner" :id="card.id" class="btn btn-danger">Удалить</button><br/>
  </div>
</template>
